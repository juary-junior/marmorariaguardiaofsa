        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <a href={COMPANY.linkedin} className="flex h-9 w-9 items-center justify-center rounded-full border border-border/20 text-muted-foreground transition-colors hover:border-primary hover:text-primary">
                <Linkedin size={16} />
              </a>
            </div>
          </div>
